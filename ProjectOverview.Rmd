...
The **for-loop with same genre** performed best qualitatively, which is the fastest within the four scenarios, but still slow (takes about 2-3 seconds for a reccomendation).
