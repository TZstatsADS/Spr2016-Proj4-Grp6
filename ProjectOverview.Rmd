...
3. Preprocessing:
  -XML Parsing of desired info (ie: review score), and removing of undesired info (ie: price)
...
##XML Parsing
The XML parsing was our main source of preprocessing. This "separated" out the information we wanted on each of the movies, and formatted it ina way we could manipulate in R. We also removed factors and information that we would not be using in our algorithm or analysis. 
...
#The App
*For the algorithm formulation, we used both Python and R; See Main.R for the executable code*
